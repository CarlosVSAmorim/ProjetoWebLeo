...
function getCurrentRole() {
    ...
    if (rawUser) {
        try {
            ...
            console.error('Erro ao ler currentUser:', e);
        }
    }
    return role;
}
...
function adicionarGarcom(e) {
    if (!isAdmin()) {
        alert('Apenas administradores podem cadastrar garçons.');
        return;
    }
...
function editarGarcom(id) {
    if (!isAdmin()) {
        alert('Apenas administradores podem editar garçons.');
        return;
    }
...
function removerGarcom(id) {
    if (!isAdmin()) {
        alert('Apenas administradores podem remover garçons.');
        return;
    }
